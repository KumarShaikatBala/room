            ...
            <div class="form-validation-style">
                <div class="bst-block">
                    <div class="bst-block-title mrgn-b-lg">
                        <h3>DInning & Resturent</h3>
                    </div>
                    <div class="bst-block-content">
                        <form class="form" action="{{ route('dinning_store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('patch') }}
...
<label>Facility</label>
                            ...
                            @else
                                <div class="form-group m-t-40 row">
                                    ...
                                    <div class="col-8">
                                        <img src="/image/dinning/{{$img}}" width="auto" height="70px" alt="No Image">
                                    </div>
                                </div>
