                        ...
                        <div class="dataTables_wrapper">
                            <div class="table-responsive">
                                <table class="table table-hover dataTable table-responsive" data-table="table-button" data-buttons="['copy', 'csv', 'excel', 'pdf', 'print']">
                                    ...
                                    <tbody>
                                    @foreach($contact as $slider)
                                    <tr>
                                        <td class="text-dark weight-600">{{$slider->note}} </td>
                                        <td>{{$slider->mobile}}</td>
                                        <td>{{$slider->email_1}}</td>
                                        <td class="text-center">
                                            {{$slider->email_2}}
                                        </td>
                                        <td class="text-center">
                                            <a href="{{route('contactinfo')}}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                        @endforeach
                                    </tbody>
