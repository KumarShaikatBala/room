            ...
            <div class="data-table-style">
                <div class="bst-block pos-relative">
                    <div class="bst-block-title mrgn-b-lg">
                        <div class="caption">
                            <a href="#slider" class="btn btn-primary" data-toggle="modal">Add Testimonial</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form action="{{ route('storeslider2')}}" method="post" id="bst_demo_form1" class="form-horizontal" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="form-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover dataTable table-responsive" data-table="table-button" data-buttons="['copy', 'csv', 'excel', 'pdf', 'print']">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{Str::words($slider->description, 11)}}</td>
                                        <td><img src="/image/slider2/{{$slider->slider_image}}" width="60px" height="auto"></td>
                                        <td class="text-center">
                                            ...
                                            <a href="{{route('deleteslider2',['id'=>$slider->id])}}" onclick="return confirm('Confirm Delete?')"><i class="mdi mdi-delete font-18">Delete</i></a>
                                        </td>
                                    </tr>
                                        @endforeach
                                    </tbody>
