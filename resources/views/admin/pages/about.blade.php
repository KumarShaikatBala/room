                        ...
                        <form class="form" action="{{ route('about_store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    @if (empty($about))<textarea  id="summernote" class="summernote"  name="about" placeholder="Input your Message"></textarea>@else<textarea  id="summernote" class="summernote" name="about" placeholder="Input your Address">{{$about}}</textarea>@endif
                            ...
                            @else
                                <div class="form-group m-t-40 row">
                                    ...
                                    <div class="col-8">
                                        <img src="/image/about/{{$img}}" width="auto" height="70px" alt="No Image">
                                    </div>
                                </div>
