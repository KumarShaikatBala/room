            ...
            <div class="data-table-style">
                <div class="bst-block pos-relative">
                    <div class="bst-block-title mrgn-b-lg">
                        <div class="caption">
                            <a href="#slider" class="btn btn-primary" data-toggle="modal">Add Menu</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form action="{{ route('storeslider3')}}" method="post" id="bst_demo_form1" class="form-horizontal" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label col-md-12 col-sm-12 col-12">Price<span class="required"> * </span> </label>
                                                                <div class="col-md-12 col-sm-12 col-12">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label col-md-12 col-sm-12 col-12">Image <span class="required"> * </span> </label>
                                                                <div class="col-md-12 col-sm-12 col-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover dataTable table-responsive" data-table="table-button" data-buttons="['copy', 'csv', 'excel', 'pdf', 'print']">
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="/image/slider3/{{$slider->slider_image}}" width="60px" height="auto" alt="No Image"></td>
                                        <td class="text-center">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <form action="{{ route('updateslider3',['id'=>$slider->id])}}" method="post" id="bst_demo_form1" class="form-horizontal" enctype="multipart/form-data">
                                                                        @csrf
                                                                        <div class="form-body">
                                                                            <div class="form-group">
                                                                                <label class="control-label col-md-12 col-sm-12 col-12">Name<span class="required"> * </span> </label>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label class="control-label col-md-12 col-sm-12 col-12">Designation<span class="required"> * </span> </label>
                                                                                <div class="col-md-12 col-sm-12 col-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-12 col-sm-12 col-12">
                                                                                    <img src="/image/slider3/{{$slider->slider_image}}" width="60px" height="auto">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                            ...
                                            <a href="{{route('deleteslider3',['id'=>$slider->id])}}" onclick="return confirm('Confirm Delete?')"><i class="mdi mdi-delete font-18">Delete</i></a>
                                        </td>
                                    </tr>
                                        @endforeach
                                    </tbody>
