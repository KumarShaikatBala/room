...
$(function() {
    ...
    // Setup flash version
    $(".flash-file-upload").pluploadQueue({
    ...
    // Setup html5 version
    $(".html5-file-upload").pluploadQueue({
    ...
    // Setup html4 version
    $(".html4-file-upload").pluploadQueue({
        runtimes: 'html4',
        url: '/',
        unique_names: true,
        filters: {
    ...
    // Events
    $(".uploader-file-events").pluploadQueue({
        ...
        init: {
            ...
            FileUploaded: function(up, file, info) {
                log('[FileUploaded] File:', file, "Info:", null); // Called when file has finished uploading
            },
